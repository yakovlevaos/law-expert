...
const library = [
  ...
  },
  {
    ...
    detailedDescription:
      "Популярная серия файтингов, которая отличается низким порогом вхождения (достаточно простым освоением игровых механик в сравнении с другими файтингами) и жестокостью. Каждая часть MK предлагает свои уникальные особенности и может похвастаться уникальной сюжетной линией, а также различными однопользовательскими и многопользовательскими режимами.\n",
  ...
  },
  {
    ...
    picture: "Biomutant",
    detailedDescription:
      "Игра о мире антропоморфных животных, которые живут в постапокалиптическом мире. Вы создаете своего енотоподобного персонажа, выбираете ему внешность, класс и способности, которые в дальнейшем можно будет прокачивать.",
  ...
  },
  {
    ...
    detailedDescription:
      "Четвертая часть серии игр Streets of Rage сделана в стиле прошлых игр серии: дух старых боевиков и понятная и неплохая боевая система. В игре доступно большое количество персонажей, у каждого из которых свой стиль игры. Также игру можно проходить в кооперативе.",
    screenshots: [
      "Streets of Rage 4 1",
      "Streets of Rage 4 2",
      "Streets of Rage 4 3",
  ...
  },
  {
    ...
    detailedDescription:
      "Серия игр про знаменитого вымышленного частного детектива, который раскрывает различные преступления. Вы решаете различные головоломки, находите разные элементы и улики, которые затем анализируете и делаете выводы (некая интерпретация знаменитой дедукции Шерлока Холмса).",
    screenshots: [
  ...
  },
  {
    ...
    picture: "CallOfDuty2",
    detailedDescription:
      "Игра основана на событиях Второй мировой войны. Call of Duty 2 представляет из себя шутер от первого лица, в котором вы возьмете на себя роль солдатов советской, британской и американской армий.",
    screenshots: [
      "Call of Duty 2 - 1",
      "Call of Duty 2 - 2",
      "Call of Duty 2 - 3",
  ...
  },
  {
    ...
    detailedDescription:
      "Игра охватывает боевые действия в оккупированных городах Франции, Бельгии, а также в Германии во время Второй мировой войны. Call of Duty: World War II представляет из себя шутер от первого лица, в котором вы возьмете на себя роль разных солдат.",
    screenshots: [
