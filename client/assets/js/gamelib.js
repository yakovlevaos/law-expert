...
const library = [
  ...
  },
  {
    ...
    picture: "SM2",
    detailedDescription:
      "Сиквел истории о Человеке-пауке, которая посвящена теперь сразу двум паучкам: Питеру Паркеру и Майлзу Моралесу. Игра рассказывает о\n" +
  ...
  },
  {
    ...
    picture: "TLOU",
    detailedDescription:
      "История о том, как во время начала эпидемии, которая в итоге привела человечество к зомби апокалипсису, отец потерял свое дитя. На протяжении\n" +
  ...
  },
  {
    ...
    picture: "BAT",
    detailedDescription:
      "Серия игр, посвященная темному рыцарю, супергерою Бэтмену. В каждой из частей серии, события которой длятся 1 ночь, Бэтмену придется\n" +
  ...
  },
  {
    ...
    picture: "SK",
    detailedDescription:
      "Место действия 5-ой части The Elder Scrolls происходят в провинции Скайрим, на севере Тамриэля. Много лет никто не видел драконов, однако один из\n" +
  ...
  },
  {
    ...
    picture: "SB",
    detailedDescription:
      "Игры про Губку Боба квадратные штаны, о котором выходят мультсериалы и мультфильмы. Яркий, красочный платформер, в котором вы побываете в\n" +
      "\n" +
  ...
  },
  {
    ...
    picture: "U",
    detailedDescription:
      "Серия игр Uncharted – это буквально игровая и более современная версия Индианы Джонса. Главный герой Нейтан Дрейк каждый раз отправляется\n" +
  ...
  },
  {
    ...
    picture: "ST",
    detailedDescription:
      "Милый фиолетовый дракончик по имени Спайро отправляется на встречу опасности, чтобы спасти других драконов и их яйца. Игровой процесс\n" +
  ...
  },
  {
    ...
    picture: "SF",
    detailedDescription:
      "Очередная игра про сверхбыстрого ежика Соника, где вы создаете своего собственного антропоморфного персонажа.",
  ...
  },
  {
    ...
    picture: "SH",
    detailedDescription:
      "Небольшая история о школьных подругах. Главная героиня - Анита, которая пытается понять, что случилось с ее подругой Майей. Игра затрагивает темы\n" +
      "\n" +
  ...
  },
  {
    ...
    picture: "ES4",
    detailedDescription:
      "По всему Тамриэлю (вымышленный континент, на котором происходят действия игры) начинают открываться врата в параллельный мир – Обливион. С\n" +
  ...
  },
  {
    ...
    picture: "ES",
    detailedDescription:
      "Фэнтезийная игра, в которой вы можете свободно исследовать мир, выбирая свой собственный путь на встречу приключениям. Morrowind предлагает\n" +
      "множество разнообразных квестов, возможность создать своего собственного героя (выбрать пол, расу, класс), богатый лор и глубокую историю. Также\n" +
      "\n" +
      "вы можете прокачивать навыки вашего персонажа на свое усмотрение под собственный стиль игры.",
    screenshots: [
  ...
  },
  {
    ...
    picture: "TMNT",
    detailedDescription:
      "Относительно новая игра про четырех зеленых братьев максимально сохраняет старых дух и геймплей ретро игр про черепашек ниндзя. Визуально игра\n" +
  ...
  },
  {
    ...
    picture: "Stray",
    detailedDescription:
      "Вы берете под управление бездомного кота, который ненарочно падает в пропасть и попадает в мир, населенный роботами. Ваша цель – найти способ\n" +
  ...
  },
  {
    ...
    picture: "SW",
    detailedDescription:
      "Игры из серии Jedi - часть легендарной франшизы «Звездные войны». В них игрок выступает в роли Кэла Кестиса - джедая-ученика в изгнании,\n" +
  ...
  },
  {
    ...
    picture: "SMO",
    detailedDescription:
      "Очередная игра про водопроводчика Марио, который отправляется на спасение своей принцессы. Игра имеет яркий визуальный стиль, разнообразные\n" +
  ...
  },
  {
    ...
    picture: "Zelda",
    detailedDescription:
      "Главный герой игр – Линк, отправляется в удивительное, но опасное приключения в мир, полным загадок, врагов и древних тайн. В играх представлена\n" +
      "большая свобода действий и простор для креатива и воображения. В The Legend of Zelda: Tears of the Kingdom и The Legend of Zelda: Breath of the Wild\n" +
      "множество мелких деталей: главный герой может уставать, соскальзывать со скалы во время дождя, замерзать без теплой одежды, оружие со временем\n" +
      "\n" +
      "ломается и так далее.",
    screenshots: [
  ...
  },
  {
    ...
    picture: "MMS",
    detailedDescription:
      "Marvel’s Midnight Suns - нестандартная игра по мотивам комиксов, выполненная в жанре тактической ролевой игры. В центре выступает персонаж\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Популярная серия файтингов, которая отличается низким порогом вхождения (достаточно простым освоением игровых механик в сравнении с другими\n" +
      "файтингами) и жестокостью. Каждая часть MK предлагает свои уникальные особенности и может похвастаться уникальной сюжетной линией, а также\n" +
      "\n" +
      "различными однопользовательскими и многопользовательскими режимами/",
  ...
  },
  {
    ...
    detailedDescription:
      "Игра в жанре платформинга, где главным героем выступает сверхбыстрый ежик Соник. В игре присутствует небольшой открытый мир.",
    screenshots: [
      "Sonic Frontiers 1",
      "Sonic Frontiers 2",
      "Sonic Frontiers 3",
  ...
  },
  {
    ...
    detailedDescription:
      "Аркадный симулятор скейтбординга. К вашему распоряжению представлено большое количество разнообразных локаций, на которых вы можете\n" +
  ...
  },
  {
    ...
    picture: "TheSims",
    detailedDescription:
      "Симулятор жизни, который позволяет создать своих собственных персонажей, построить дом, обустроить его, поработать с интерьером, а затем прожить\n" +
  ...
  },
  {
    ...
    picture: "Tekken",
    detailedDescription:
      "Серия игр в жанре файтинг. Главная особенность игрового процесса серии - за каждую кнопку геймпада отвечает отдельная конечность персонажа.",
  ...
  },
  {
    ...
    picture: "SoulCalibur",
    detailedDescription:
      "Серия файтингов, где персонажи вооружены различным оружием ближнего боя.",
  ...
  },
  {
    ...
    picture: "Unravel2",
    detailedDescription:
      "Игра-головоломка о двух вязанных человечках, которые должны совместными усилиями решать головоломки различной сложности.",
  ...
  },
  {
    ...
    detailedDescription:
      "В Riders Republic представлены четыре основных экстремальных видах спорта: катание на горных велосипедах, катание на лыжах, сноуборде и полеты в\n" +
      "\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Действие игры разворачивается в городе Ракун-сити, охваченном эпидемией зомби. Игроки могут взять на себя роли двух героев: Леона Кеннеди,\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Седьмая часть стала неким переосмыслением серии. Камера теперь переместилась и вместо вида из-за плеча теперь камера от первого лица. А также\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Восьмая часть серии продолжает историю Итана. На этот раз он попадает в загадочную деревушку, в которой он обнаруживает множество мистических\n" +
  ...
  },
  {
    ...
    picture: "Sackboy",
    detailedDescription:
      "Платформер из вселенной «Little Big Planet», который в отличии от других игр серии выполнен не в 2.5D с видом сбоку, а в полноценном 3D\n" +
      "\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Главные герои: Крис Редфилд и Шева Аламар отправляются в Африку, чтобы раскрыть причины вспышки инфекции. Игровой процесс в своей основе\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Resident Evil 6 представляет сразу 4 сюжетные кампании, которые разворачиваются параллельно. Базовый геймплей остался тот же, что и в двух\n" +
  ...
  },
  {
    ...
    picture: "TombRaider",
    detailedDescription:
      "Перезапуск серии, который рассказывает о новых приключениях расхитительницы гробниц Лары Крофт. Как и раньше, Лара Крофт много времени\n" +
  ...
  },
  {
    ...
    picture: "NinjaGaiden",
    detailedDescription:
      "Данный сборник включает 3 видеоигры, повествующих о мастере-ниндзя Рю Хаябусе, противостоящем ордам демонов. Данные игры известны высокой\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Главный герой - Саргон, молодой член клана воинов под названием «Бессмертные», который вместе с другими членами клана должны защитить принца\n" +
      "Персии и противостоять злу. Игра выполнена в 3 с видом сбоку (так называемое 2.5D), а ее игровые механики делают акцент на паркуре, эффектных\n" +
      "\n" +
      "боях, решении головоломок и исследовании локаций, взаимосвязанных в большую карту.",
    screenshots: [
  ...
  },
  {
    ...
    picture: "Sekiro",
    detailedDescription:
      "Игры от разработчиков FromSoftware, так называемые «Soulslike» игры, известны своей сложностью, отсутствием подсказок, карт, необходимостью\n" +
      "самостоятельно изучать игровые локации, а также геймплейные механики. Точно такой же подход у данных игр и к сюжету. Игрок самостоятельно\n" +
      "должен изучать записки и описание предметов, анализировать и связывать события между собой, чтобы образовалась более целостная картинка. В\n" +
      "Sekiro акцент в боевой системе делается на парировании вражеских атак и быстром динамичном ведении боя, что выделяет его среди других игр\n" +
      "\n" +
      "разработчиков.",
    screenshots: [
  ...
  },
  {
    ...
    picture: "UFC",
    detailedDescription:
      "Спортивный симулятор боев по смешанным единоборствам.",
  ...
  },
  {
    ...
    picture: "Starfield",
    detailedDescription:
      "Starfield - это ролевая видеоигра, в которой вам предстоит исследовать различные планеты. Игра предлагает открытый мир, что позволяет каждому\n" +
      "игроку выбирать свой собственный путь.. Starfield сочетает элементы научной фантастики с эпической историей, предоставляя игрокам возможность\n" +
      "\n" +
      "создать собственного персонажа .",
  ...
  },
  {
    ...
    picture: "LOTRGollum",
    detailedDescription:
      "Игра про одного из важных персонажей вселенной «Властелин колец» - Голлума. Игра делает упор на платформинг и стэлс механики. Игра получила\n" +
      "\n" +
  ...
  },
  {
    ...
    picture: "Sifu",
    detailedDescription:
      "Игровой процесс Sifu делает упор на боевую механику. Особенностью игры является высокая сложность, а также «старение» главного героя после\n" +
      "\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Четвертая часть серии игр Streets of Rage сделана в духе прошлых игр серии: дух старых боевиков и понятная и неплохая боевая система. В игре доступно\n" +
      "\n" +
      "большое количество персонажей, у каждого из которых свой стиль игры. Также игру можно проходить в кооперативе.",
    screenshots: [
      "Streets of Rage 4 1",
      "Streets of Rage 4 2",
      "Streets of Rage 4 3",
  ...
  },
  {
    ...
    detailedDescription:
      "Главный герой воин Вандер с помощью меча и лука должен уничтожить всех огромных колоссов. Одной из главных особенностей игры является\n" +
      "\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Файтинг, в которой вашей главной задачей становится столкнуть противников за пределы арены. В вашем распоряжении множества десятков арен, а\n" +
      "\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Игра о противостоянии империи и республики, где вы можете выбрать не только одну из сторон, но и класс воина, а в какие-то определенные моменты\n" +
      "\n" +
  ...
  },
  {
    ...
    detailedDescription:
      "Серия игр про знаменитого вымышленного частного детектива, который раскрывает различные преступления. Вы решаете различные головоломки,\n" +
      "находится разные элементы и улики, которые затем анализируете и делаете выводы (некая интерпретация знаменитой дедукции Шерлока Холмса).",
    screenshots: [
  ...
  },
  {
    ...
    detailedDescription:
      "Главный герой серии – шпион, работающий на агентство национальной безопасности. Игровой процесс делает упор на скрытное прохождение. У Сэма в\n" +
  ...
  },
  {
    ...
    picture: "WatchDogs",
    detailedDescription:
      "Серия игр, в которых игрок примеряет на себя хакеров, способных управлять технологиями и системами в современных городах. Таким образом хакеры\n" +
      "пытаются бороться с преступностью и коррупцией. В игре доступен открытый мир, по которому вы можете передвигаться на различном транспорте. В\n" +
      "каждой из частей есть свои геймплейные особенности. Например, во второй части вы можете включить плеер на игровом телефоне, а в Legion брать под\n" +
      "\n" +
      "управление разных граждан.",
  ...
  },
  {
    ...
    picture: "Ryse",
    detailedDescription:
      "Ryse: Son of Rome - историко - фантастический экшн, события которого происходят в древнем Риме. Сюжет является вымышленным с примесью\n" +
  ...
  },
  {
    ...
    picture: "STALKER",
    detailedDescription:
      "Действия игры разворачиваются в зоне отчуждения вокруг Чернобыльской атомной электростанции, где после катастрофы произошли аномальные\n" +
      "\n" +
...
const dropdownData = {
  ...
  type: {
    1: "Одиночный",
    2: "Локальный кооператив",
    3: "Локальное противостояние",
    4: "Мультиплеерный кооператив",
    5: "Мультиплеерное противостояние",
  },
  competencies: {
