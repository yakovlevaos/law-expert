...
const library = [
  ...
  },
  {
    ...
    picture: "SW",
    detailedDescription:
      "Игры серии Jedi франшизы «Звездные войны» повествуют о парне по имени Кал. Он обладает силой джедаев, но скрывает свой дар, чтобы остаться в\n" +
      "живых. Однажды стечение обстоятельств все-таки вынуждают его раскрыть себя. Он встречает на своем пути героев, которые постепенно становятся его\n" +
      "командной и семьей. Кал вспоминает свои старые уроки и постепенно становится полноценным джедаем, который выступает против империи.",
    screenshots: [
  ...
  },
  {
    ...
    detailedDescription:
      ...
      "находится Матерь Миранда. На этот раз игру можно пройти как от первого, так и от третьего лица. А геймплей ушел в сторону экшна.",
    screenshots: [
      "Resident Evil 8 1",
      "Resident Evil 8 2",
      "Resident Evil 8 3",
