...
const expertsData = [
  ...
  },
  {
    ...
    description: `
    Директор МАУ «Центр психолого-педагогической, медицинской и социальной помощи «Эго». Экспертный стаж 9 лет, специализация по вопросам экспертизы несовершеннолетних,
  ...
  },
  {
    ...
    description: `
    Директор МАУ «Центр психолого-педагогической, медицинской и социальной помощи «Сознание»
    Медиация:
  ...
  },
  {
    ...
    photo: "sedykh-photo",
    docs: [],
    title: `Практический, клинический психолог, сертифицированный специалист с опытом работы более 6 лет, эксперт ЦППС «Генезис» по работе с новой методикой «Консультирование с помощью видеоигр»
`,
    description: `Преодоление эмоционального выгорания и стресса, работа с психосоматикой, работа с тревожностью и нарушениями пищевого поведения, построение эффективных коммуникаций (в семье, паре, рабочей среде), поиск личных ресурсов и восстановление внутреннего равновесия.`
  },
  {
  ...
  },
  {
    ...
    docs: [],
    title:
      "Практический детский психолог, психолог-консультант с опытом работы более 7 лет",
    description:
