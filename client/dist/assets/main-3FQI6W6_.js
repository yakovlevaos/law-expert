import{S as l}from"./index-1O3jh5MZ.js";import{i as o}from"./modal-Yooto6kQ.js";/* empty css              */const c=[{index:1,title:"Психологические консультации с помощью видеоигр",period:"Летний период 2024 года.",coverage:"Более 1500 детей, проживающих на территории города Красноярска.",place:"Загородный лагерь «Ласточка».",funding:"Cубсидия департамента социального развития администрации города Красноярска, собственные средства.",partners:["Муниципальное автономное учреждение «Центр психолого-педагогической, медицинской и социальной помощи «Эго»","Загородный стационарный детский оздоровительный лагерь «Ласточка»","Муниципальное молодежное автономное учреждение «ИТ-Центр»"],description:`Дети-подростки в возрасте с 10 до 17 лет, отдыхающие в
  ...
  `,g=()=>{const t=document.getElementById("cardsContainer");t.innerHTML=c.map((i,s)=>p(i,s)).join(""),d.init();const e=o();e&&document.querySelectorAll(".card-screenshot").forEach(i=>{i.addEventListener("click",function(){e(this.src)})})};g();
